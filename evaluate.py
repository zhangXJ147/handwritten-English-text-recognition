...
if __name__ == '__main__':
    ...
    pretrained_dict_path = os.path.join(BASE_DIR, '..', 'checkpoints', '89CTN_loss1.4620513246966773_acc0.8501290473955889_avgCER0.05362447643437566_avgWER0.14987095260441108.pth')
